...
# Data loading and splitting
    ...
    model = UDACounting(in_size=args.image_resize, dropout=args.dropout, momentum=args.BN_momentum)
    model.to(device)
    ...
    for epoch in range(args.epoch):
        ...
        for batch_idx, (source_data, target_data) in enumerate(itertools.zip_longest(source_dataloader, target_dataloader_train)):
            ...
            source_domain_label = torch.zeros(args.batch_size).long().to(device)
